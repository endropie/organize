...
class Filter
{
    ...
    public function apply(Builder $builder)
    {
        ...
        foreach ($this->filters() as $name => $value) {
            ...
            if ( ! method_exists($this, $name)) {
                // if (gettype($value) != 'string') dd($value, $name, $fields);
                if(gettype($value) == 'string' && strlen($value) && in_array($name, $fields)) {
    ...
    public function x__with($values) {
        // $with = ;
    ...
    public function x__select($values = false) {
        // $with = ;
    ...
    public function limit($value = 50) {
        $value = (int) $value;
