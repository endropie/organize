<div>
    ...
    <span class="">
        ...
        <a href="{{ url('members/'. $member->id) }}" target="_{{ $member->id }}" class="px-4 py-1 text-white bg-green-600 rounded hover:bg-green-400 focus:bg-green-400 focus:outline-none" >Lihat</a>
        @endif
        @else
