...
<x-website-layout>
    <div class="h-screen pb-14 bg-right bg-cover" style="background-image:url('https://raw.githubusercontent.com/tailwindtoolbox/App-Landing-Page/master/bg.svg');">

        <!--Main-->
        <div class="container pt-10 xl:pt-36 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="w-full xl:w-3/5 py-6 overflow-y-hidden">
                <img class="w-5/6 mx-auto lg:mr-0 slide-in-bottom" src="https://raw.githubusercontent.com/tailwindtoolbox/App-Landing-Page/master/devices.svg">
            </div>
